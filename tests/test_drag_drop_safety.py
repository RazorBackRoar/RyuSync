...
def test_dry_mode_performs_zero_filesystem_mutations(
...
def test_regular_mode_deletes_urls_but_preserves_other_unrelated_files(
    tmp_path: Path, qapp: QApplication
) -> None:
...
def test_worker_safety_prevents_outside_mutations(
    tmp_path: Path, qapp: QApplication
) -> None:
